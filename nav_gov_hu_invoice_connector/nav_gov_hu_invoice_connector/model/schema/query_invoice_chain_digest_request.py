...
from nav_gov_hu_invoice_connector.nav_gov_hu_invoice_connector.model.schema.type.query_invoice_chain_digest_request_type import \
...
class QueryInvoiceChainDigestRequest(QueryInvoiceChainDigestRequestType):
    """QueryInvoiceChainDigestRequest -- A POST /queryInvoiceChainDigest REST operáció kérésének root elementje
