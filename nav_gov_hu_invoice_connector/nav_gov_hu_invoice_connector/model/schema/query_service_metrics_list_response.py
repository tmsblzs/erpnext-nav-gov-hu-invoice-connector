...
from nav_gov_hu_invoice_connector.nav_gov_hu_invoice_connector.model.schema.type.query_service_metrics_list_response_type import \
...
class QueryServiceMetricsListResponse(QueryServiceMetricsListResponseType):
    """QueryServiceMetricsListResponse -- A GET /queryServiceMetrics/list REST operáció válaszának root elementje
    ...
    def export(self, outfile, level, namespaceprefix_='',
               ...
               name_='QueryServiceMetricsListResponse', pretty_print=True):
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_,
                               name_='QueryServiceMetricsListResponse')
        if self._hasContent():
            outfile.write('>%s' % (eol_,))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_,
                                 name_='QueryServiceMetricsListResponse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='',
                          name_='QueryServiceMetricsListResponse'):
        super(QueryServiceMetricsListResponse, self)._exportAttributes(outfile, level, already_processed,
                                                                       namespaceprefix_,
                                                                       name_='QueryServiceMetricsListResponse')

    def _exportChildren(self, outfile, level, namespaceprefix_='',
                        namespacedef_='xmlns:tns="http://schemas.nav.gov.hu/NTCA/1.0/common"',
                        name_='QueryServiceMetricsListResponse', fromsubclass_=False, pretty_print=True):
        super(QueryServiceMetricsListResponse, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_,
