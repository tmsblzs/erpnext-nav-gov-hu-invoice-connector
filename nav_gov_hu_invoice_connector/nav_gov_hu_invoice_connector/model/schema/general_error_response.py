...
from nav_gov_hu_invoice_connector.nav_gov_hu_invoice_connector.model.schema.type.general_error_response_type import \
...
class GeneralErrorResponse(GeneralErrorResponseType):
    """GeneralErrorResponse -- Online Számla rendszerre specifikus általános hibaválasz
