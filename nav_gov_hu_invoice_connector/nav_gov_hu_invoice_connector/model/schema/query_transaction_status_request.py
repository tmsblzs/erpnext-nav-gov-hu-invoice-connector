...
from nav_gov_hu_invoice_connector.nav_gov_hu_invoice_connector.model.schema.type.query_transaction_status_request_type import \
...
class QueryTransactionStatusRequest(QueryTransactionStatusRequestType):
    """QueryTransactionStatusRequest -- A POST /queryTransactionStatus REST operáció kérésének root elementje
