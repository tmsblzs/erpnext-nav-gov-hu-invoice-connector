from nav_gov_hu_invoice_connector.nav_gov_hu_invoice_connector.model.online_invoice import GeneratedsSuper, \
    CurrentSubclassModule_, ModulenotfoundExp_, GenerateDSNamespaceDefs_, UseCapturedNS_, showIndent, \
    GenerateDSNamespaceTypePrefixes_, SaveElementTreeNode, Tag_pattern_, find_attr_value_, getSubclassFromModule_
from nav_gov_hu_invoice_connector.nav_gov_hu_invoice_connector.model.schema.type.basic_response_type import BasicResponseType
...
class GeneralErrorHeaderResponseType(BasicResponseType):
    """GeneralErrorHeaderResponseType -- Általános hibatípus minden REST operációra
    ...
    def export(self, outfile, level, namespaceprefix_='',
               ...
               name_='GeneralErrorHeaderResponseType', pretty_print=True):
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_,
                               name_='GeneralErrorHeaderResponseType')
        if self._hasContent():
            outfile.write('>%s' % (eol_,))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_,
                                 name_='GeneralErrorHeaderResponseType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='',
                          name_='GeneralErrorHeaderResponseType'):
        super(GeneralErrorHeaderResponseType, self)._exportAttributes(outfile, level, already_processed,
                                                                      namespaceprefix_,
                                                                      name_='GeneralErrorHeaderResponseType')
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='',
                        namespacedef_='xmlns:tns="http://schemas.nav.gov.hu/NTCA/1.0/common"',
                        name_='GeneralErrorHeaderResponseType', fromsubclass_=False, pretty_print=True):
        super(GeneralErrorHeaderResponseType, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_,
