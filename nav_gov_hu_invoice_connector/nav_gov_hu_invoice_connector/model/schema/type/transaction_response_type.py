...
class TransactionResponseType(BasicOnlineInvoiceResponseType):
    """TransactionResponseType -- A POST /manageInvoice és a POST /manageAnnulment REST operáció közös válasz típusa
    Common response type of the POST /manageInvoice and the POST /manageAnnulment REST operation
    transactionId -- A kért operáció tranzakció azonosítója
