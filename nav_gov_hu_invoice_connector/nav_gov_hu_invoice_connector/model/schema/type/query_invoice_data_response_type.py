...
from nav_gov_hu_invoice_connector.nav_gov_hu_invoice_connector.model.schema.type.invoice_data_result_type import \
...
class QueryInvoiceDataResponseType(BasicOnlineInvoiceResponseType):
    """QueryInvoiceDataResponseType -- A POST /queryInvoiceData REST operáció válasz típusa
    Response type of the POST /queryInvoiceData REST operation
    invoiceDataResult -- A számla lekérdezés eredménye
