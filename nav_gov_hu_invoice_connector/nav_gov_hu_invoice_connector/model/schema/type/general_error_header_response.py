...
from nav_gov_hu_invoice_connector.nav_gov_hu_invoice_connector.model.online_invoice import GeneratedsSuper, \
    CurrentSubclassModule_, getSubclassFromModule_, \
    GenerateDSNamespaceDefs_, UseCapturedNS_, showIndent, ModulenotfoundExp_, \
...
class GeneralErrorHeaderResponse(GeneralErrorHeaderResponseType):
    """GeneralErrorHeaderResponse -- Az összes REST operációra vonatkozó hibaválasz generikus elementje
    ...
    def export(self, outfile, level, namespaceprefix_='',
               ...
               name_='GeneralErrorHeaderResponse', pretty_print=True):
        ...
        if self._hasContent():
            ...
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_,
                                 name_='GeneralErrorHeaderResponse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='',
                          name_='GeneralErrorHeaderResponse'):
        super(GeneralErrorHeaderResponse, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_,
                                                                  name_='GeneralErrorHeaderResponse')

    def _exportChildren(self, outfile, level, namespaceprefix_='',
                        namespacedef_='xmlns:tns="http://schemas.nav.gov.hu/NTCA/1.0/common"',
                        name_='GeneralErrorHeaderResponse', fromsubclass_=False, pretty_print=True):
        super(GeneralErrorHeaderResponse, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_,
