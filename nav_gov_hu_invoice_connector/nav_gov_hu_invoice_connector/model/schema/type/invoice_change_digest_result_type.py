...
from nav_gov_hu_invoice_connector.nav_gov_hu_invoice_connector.model.schema.type.invoice_chain_element_type import \
...
class InvoiceChainDigestResultType(GeneratedsSuper):
    """InvoiceChainDigestResultType -- Számlalánc kivonat lekérdezés eredményei
    ...
    invoiceChainElement -- Számlalánc elem
    ...
    def export(self, outfile, level, namespaceprefix_='',
               ...
               name_='InvoiceChainDigestResultType', pretty_print=True):
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_,
                               name_='InvoiceChainDigestResultType')
        if self._hasContent():
            outfile.write('>%s' % (eol_,))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_,
                                 name_='InvoiceChainDigestResultType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='',
                        namespacedef_='xmlns:tns="http://schemas.nav.gov.hu/NTCA/1.0/common" xmlns:common="http://schemas.nav.gov.hu/NTCA/1.0/common"  xmlns:None="http://schemas.nav.gov.hu/OSA/3.0/metrics" ',
                        name_='InvoiceChainDigestResultType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        for invoiceChainElement_ in self.invoiceChainElement:
            namespaceprefix_ = self.invoiceChainElement_nsprefix_ + ':' if (
                        UseCapturedNS_ and self.invoiceChainElement_nsprefix_) else ''
            invoiceChainElement_.export(outfile, level, namespaceprefix_, namespacedef_='', name_='invoiceChainElement',
