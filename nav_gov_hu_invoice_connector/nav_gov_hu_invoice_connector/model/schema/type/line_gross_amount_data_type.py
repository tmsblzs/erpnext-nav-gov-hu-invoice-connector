...
class LineGrossAmountDataType(GeneratedsSuper):
    """LineGrossAmountDataType -- Tétel bruttó adatok
    Line gross data
    lineGrossAmountNormal -- Tétel bruttó értéke a számla pénznemében.
        ÁFA tartalmú különbözeti adózás esetén az ellenérték.
    Gross amount of the item expressed in the currency of the invoice. In case of margin scheme taxation containing VAT,
        the amount of consideration expressed in the currency of the invoice.
    lineGrossAmountNormalHUF -- Tétel bruttó értéke forintban
