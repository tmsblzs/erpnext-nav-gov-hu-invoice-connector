...
from nav_gov_hu_invoice_connector.nav_gov_hu_invoice_connector.model.schema.type.query_invoice_chain_digest_response_type import \
...
class QueryInvoiceChainDigestResponse(QueryInvoiceChainDigestResponseType):
    """QueryInvoiceChainDigestResponse -- A POST /queryInvoiceChainDigest REST operáció válaszának root elementje
