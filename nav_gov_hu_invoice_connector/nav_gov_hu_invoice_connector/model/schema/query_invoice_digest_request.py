...
from nav_gov_hu_invoice_connector.nav_gov_hu_invoice_connector.model.schema.type.query_invoice_digest_request_type import \
...
class QueryInvoiceDigestRequest(QueryInvoiceDigestRequestType):
    """QueryInvoiceDigestRequest -- A POST /queryInvoiceDigest REST operáció válaszának root elementje
